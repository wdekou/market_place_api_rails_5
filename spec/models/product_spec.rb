describe Product do
  ...
  describe '.filter_by_title' do
    ...
    context "when a 'TV' title is sent" do
  ...
  describe ".above_or_equal_to_price" do
    ...
    it 'returns the products which are above or equal to the prior' do
  ...
  describe ".search" do
    ...
    context 'when an empty hash is sent' do
      it 'returns all the products' do
        expect(Product.search({})).to match_array [@product1, @product3, @product2, @product4 ]
      end
    end
